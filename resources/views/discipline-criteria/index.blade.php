            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('discipline.criteria.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-200">
                                <tr>
                                    <th class="w-3/4 py-3 px-4 uppercase font-semibold text-sm text-left">Nama Kriteria</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-center">
                                        <div class="flex item-center justify-center">
                                            <a href="{{ route('discipline.criteria.edit', $criterion->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </a>
                                            <form action="{{ route('discipline.criteria.destroy', $criterion->id) }}" method="POST" onsubmit="return confirm('Yakin?');">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center py-4">Tidak ada data kriteria disiplin.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
