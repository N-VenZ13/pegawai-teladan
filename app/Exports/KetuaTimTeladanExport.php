...
class KetuaTimTeladanExport implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    ...
    public function __construct(Period $period)
    {
        ...
        $this->recapData = $recapController->calculateRecap($period, 'ketua_tim');
    }
    ...
    {
        return 'Rekapitulasi Ketua Tim Teladan';
    }
}
